...
class MaintenanceSignUp extends Component{
    ...
    constructor(props){
        ...
        this.handleMaintenanceSignUp = this.handleMaintenanceSignUp.bind(this);
    }
    ...
    render(){
        ...
        if(this.state.authFlag){
            redirectVar = <Redirect to= "/maintenancelogin"/>
        }
        return(
            <div>
             {redirectVar} 
            ...
            <a href="/maintenancelogin">Log in</a>
            </div>
            ...
            <div className="container">             
                <div className="login-form">
                    ...
                    <p class="panel-title">Create an Account</p>
                             ...
                             <form  onSubmit = {this.handleMaintenanceSignUp}>
...
export default MaintenanceSignUp;