...
class ManagerSignUp extends Component{
    ...
    constructor(props){
        ...
        this.handleManagerSignUp = this.handleManagerSignUp.bind(this);
    }
    ...
    render(){
        ...
        if(this.state.authFlag){
            redirectVar = <Redirect to= "/managerlogin"/>
        }
        return(
            <div>
                {redirectVar}
            ...
            <div className="container">             
                <div className="login-form">
                    ...
                    <p className="panel-title">Create an Account</p>
                            ...
                            <form  onSubmit = {this.handleManagerSignUp}>
